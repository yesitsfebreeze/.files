// §source home/dot_config/wp-stat-overlay/helper/keyboard_windows.go
//go:build windows
...
func init() {
// §.splinter/home/dot_config/wp-stat-overlay/helper/keyboard_windows/init.fs
}

func hookProc(nCode int, wParam, lParam uintptr) uintptr {
// §.splinter/home/dot_config/wp-stat-overlay/helper/keyboard_windows/hookProc.fs
}
...
func hookLoop() {
// §.splinter/home/dot_config/wp-stat-overlay/helper/keyboard_windows/hookLoop.fs
}

// keyIdleMs returns milliseconds since the last keystroke.
func keyIdleMs() int64 {
// §.splinter/home/dot_config/wp-stat-overlay/helper/keyboard_windows/keyIdleMs.fs
}
