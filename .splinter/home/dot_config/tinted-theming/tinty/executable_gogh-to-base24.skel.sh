# §source home/dot_config/tinted-theming/tinty/executable_gogh-to-base24.sh
#!/usr/bin/env bash
...
val() {
# §.splinter/home/dot_config/tinted-theming/tinty/executable_gogh-to-base24/val.fs
}
str() {
# §.splinter/home/dot_config/tinted-theming/tinty/executable_gogh-to-base24/str.fs
}
