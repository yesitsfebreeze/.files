# §source home/run_after_karabiner-disable-internal-keyboard.sh
#!/usr/bin/env bash
...
warn() {
# §.splinter/home/run_after_karabiner-disable-internal-keyboard/warn.fs
}
log()  {
# §.splinter/home/run_after_karabiner-disable-internal-keyboard/log.fs
}
