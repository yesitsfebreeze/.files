...
return {
  ...
  followers = {
    { key = " ", desc = "Finder", action = "FinderOpen" },


    { key = "a", desc = "←",  action = "ActivatePaneDirection", args = "Left" },
    { key = "d", desc = "→",  action = "ActivatePaneDirection", args = "Right" },

    -- Close tab (only if more than one tab open)
    { key = "q", desc = "Close tab",  action = "CloseTabIfMultiple" },
    ...
    { key = "f", desc = "Find…", children = {
      ...
      { key = "t", desc = "Themes",       action = "ThemeFzf" },
      { key = " ", desc = "Finder",       action = "FinderOpen" },
