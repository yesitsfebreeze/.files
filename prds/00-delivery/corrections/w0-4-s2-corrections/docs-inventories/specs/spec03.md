...
- [ ] **B5 — the removal is recorded, not silent.** Deleting the word alone
      ...
      **2026-08-20** because it is no longer used (see the README's exclusion
      ...
      exactly that reader.
- [ ] **B6 — the two stale board links resolve.** `](../prd/05-platform/prd.md)`
      and `](../prd/06-help/prd.md)` both point at a directory that does not
