...
Purpose: Every task in the build, with its size, its files, and its *real*
...
- [ ] Every task names its files, and no two concurrent tasks in the same wave
      name the same file.
- [ ] Every task's dependency edges exist in the other tasks' rows — no
      invented edges (the first draft had one: `S.7 → H.2`).
...
|---|---|---|---|---|---|
| P.1 | Repo skeleton: chezmoi source layout, `home/`, justfile | M | repo root | W0.3 | [`05-platform/01`](../../05-platform/01-deploy-mechanism/prd.md) |
| P.2 | `packages.yaml` + `run_onchange` installer | L | `.chezmoidata/`, `run_onchange_*` | P.1 | [`05-platform/02`](../../05-platform/02-package-provisioning/prd.md) |
| P.3 | `run_once` homebrew bootstrap | S | `run_once_before_*` | P.1 | [`05-platform/02`](../../05-platform/02-package-provisioning/prd.md) |
| P.4 | `run_after` shell-init generator (starship/zoxide/tv) | M | `run_after_*` | P.2 | [`05-platform/03`](../../05-platform/03-shell-init-generation/prd.md) |
| P.5 | Managed config surface + `dot_gitconfig.tmpl` | S | `home/dot_config/` | P.1 | [`05-platform/01`](../../05-platform/01-deploy-mechanism/prd.md) |
...
| ID | Task | Size | Files | Depends on |
|---|---|---|---|---|
| S.1 | [`04-shell/01`](../../04-shell/01-core-config/prd.md) core config, mkcd funnel, start dir | L | `env.nu`, `config.nu`, `dirstack.nu` | P.4 |
| S.2 | [`04-shell/02`](../../04-shell/02-aliases-utilities/prd.md) aliases + `cf` + pass completion | S | `config.nu`, `pass.nu` | S.1 |
| S.3 | [`04-shell/06`](../../04-shell/06-listing/prd.md) decorated ls + auto-list | M | `config.nu` | S.1 |
| S.4 | [`04-shell/03`](../../04-shell/03-zoxide/prd.md) zoxide wrappers + bare-word fallback | L | `config.nu` | S.1, P.4 |
| S.5 | [`04-shell/04`](../../04-shell/04-television/prd.md) finder + cable channels | XL | `finder.nu`, `~/.config/television/` | S.1, P.4 |
| S.6 | [`04-shell/05`](../../04-shell/05-history/prd.md) directory-scoped history | M | `config.nu` | S.5 |
| S.7 | [`04-shell/07`](../../04-shell/07-quicklist/prd.md) quicklist recents | M | `quicklist.nu`, `finder.nu` | S.4, S.5 |
| S.8 | [`04-shell/08`](../../04-shell/08-claude-launchers/prd.md) `cc`/`cr` | S | `config.nu` | S.1 |
...
| ID | Task | Size | Files | Depends on |
|---|---|---|---|---|
| E.1 | [`03-editor/01`](../../03-editor/01-options/prd.md) options + `init.lua` | M | `init.lua`, `lua/config/options.lua` | — |
| E.2 | [`03-editor/04`](../../03-editor/04-plugin-manager/prd.md) lazy.nvim bootstrap | M | `lua/config/lazy.lua` | E.1 |
| E.3 | [`03-editor/02`](../../03-editor/02-keymaps/prd.md) core keymaps | S | `lua/config/keymaps.lua` | E.1 |
| E.4 | [`03-editor/03`](../../03-editor/03-autocmds/prd.md) autocmds | S | `lua/config/autocmds.lua` | E.1 |
| E.5 | [`03-editor/11`](../../03-editor/11-colorscheme/prd.md) colorscheme + cursor | M | `plugins/colorscheme.lua` | E.2 |
| E.6 | [`03-editor/05`](../../03-editor/05-completion/prd.md) blink.cmp | M | `plugins/completion.lua` | E.2 |
| E.7 | [`03-editor/09`](../../03-editor/09-lsp/prd.md) mason + native LSP | L | `plugins/lsp.lua` | E.6 |
| E.8 | [`03-editor/10`](../../03-editor/10-treesitter/prd.md) treesitter | M | `plugins/treesitter.lua` | E.2 |
| E.9 | [`03-editor/08`](../../03-editor/08-telescope/prd.md) telescope | M | `plugins/telescope.lua` | E.2 |
| E.10 | [`03-editor/06`](../../03-editor/06-explorer/prd.md) oil | S | `plugins/explorer.lua` | E.2 |
| E.11 | [`03-editor/07`](../../03-editor/07-formatting/prd.md) conform | S | `plugins/editor.lua` | E.2 |
| E.12 | [`03-editor/12`](../../03-editor/12-small-plugins/prd.md) gitsigns/which-key/pairs | S | `plugins/editor.lua` | E.2 |
| E.13 | [`03-editor/13`](../../03-editor/13-statusline/prd.md) lualine | M | `plugins/statusline.lua` | E.5 |
| E.14 | [`03-editor/14`](../../03-editor/14-shift-select/prd.md) shift-to-select + tests | L | `lua/config/keymaps.lua`, tests | E.3 |
| E.15 | [`03-editor/15`](../../03-editor/15-markdown-tables/prd.md) table mode | S | `plugins/editor.lua` | E.2, E.11 |
...
| ID | Task | Size | Files | Depends on |
|---|---|---|---|---|
| C.1 | [`01-capsule/02`](../../01-capsule/02-dev-image/prd.md) dev image | L | `Dockerfile` | P.2 (docker installed) |
| C.2 | [`01-capsule/01`](../../01-capsule/01-container-lifecycle/prd.md) lifecycle CLI | XL | capsule tool | C.1 |
| C.3 | [`01-capsule/03`](../../01-capsule/03-credential-propagation/prd.md) credentials | L | capsule tool, setup script | C.2 |
| C.4 | [`01-capsule/04`](../../01-capsule/04-recent-workspaces/prd.md) recents picker | M | `conf/`, capsule tool | C.2, T.1 |
...
| ID | Task | Size | Files | Depends on |
|---|---|---|---|---|
| H.1 | [`06-help/01`](../../06-help/01-content-model/prd.md) content model + schema | M | `help/*.nuon` | S.1 |
| H.2 | [`06-help/02`](../../06-help/02-help-command/prd.md) `help` command + delegation | L | `help.nu` | H.1 |
| H.3 | [`06-help/03`](../../06-help/03-browser/prd.md) tv browser | S | cable channel | H.2, S.5 |
| H.4 | [`06-help/04`](../../06-help/04-drift-check/prd.md) drift check | L | `help.nu` | H.2, and every track it inspects |
| H.5 | [`06-help/05`](../../06-help/05-agent-interface/prd.md) json/md + AGENTS.md wiring | S | `help.nu`, `AGENTS.md` | H.2 |
...
[02-parallelization](../parallelization/prd.md) does. Two consequences worth
acting on:
