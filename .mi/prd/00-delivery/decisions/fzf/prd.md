...
whether or not it is wanted"). Shares 04-corrections-backlog.md with the other
decisions and with W0.6; the W0.6 edge is kept because an afk agent must not
