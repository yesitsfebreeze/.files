...
- [x] Mount three directories, restart WezTerm, press `Ctrl+Shift+S`: all
      ...
      **Six runs, and every red but one was a check that could not
      ...
      came out of it is
      [`an-absence-assertion-needs-a-positive-precondition-or-it-is-green-on-a-blank-screen`(../../../../prds/memos/an-absence-assertion-needs-a-positive-precondition-or-it-is-green-on-a-blank-screen.md).
