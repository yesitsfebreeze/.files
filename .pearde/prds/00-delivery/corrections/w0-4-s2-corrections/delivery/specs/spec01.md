...
1. **Rewrite the second Wave 0 paragraph.** Drop "three scope forks need a
   ...
   [`04-corrections-backlog`(../../../../../../../prds/00-delivery/corrections/w0-4-s2-corrections/delivery/corrections/prd.md).
...
3. **Record the burrito question as removed, not resolved.** One sentence
   ...
   [`README.md`'s exclusion entry(../../../../../../../prds/00-delivery/corrections/w0-4-s2-corrections/README.md) rather than restating the
   full rationale.
