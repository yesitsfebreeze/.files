...
```
   **Answered 2026-08-21: WezTerm owns tabs and panes.** Not a fresh call and
   ...
   `DO NOT PORT` in [`README.md`(../../../../../../../prds/00-delivery/corrections/w0-4-s2-corrections/README.md)'s exclusion list. This
   ...
   - (a) **The self-healing nine-tab floor is the model.** With burrito
     ...
     collapse to one.
     [`w0-2-terminal-respec`(../../../../../../../prds/00-delivery/corrections/w0-4-s2-corrections/backlog-closeout/specs/w0-2-terminal-respec/prd.md) R2 already carries
