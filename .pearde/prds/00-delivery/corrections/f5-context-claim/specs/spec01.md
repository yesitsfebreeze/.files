...
still reads through. **No markdown link is added** (the file's `(../../../../../../prds/00-delivery/corrections/f5-context-claim/specs/` count is
...
runs. The box stays `- [x] **B6 …`, its number is kept, and the file's `(../../../../../../prds/00-delivery/corrections/f5-context-claim/specs/`
count stays **1**.
...
- [x] Neither block adds a markdown link.
      ...
      ```
      03-f5-jump-mode/prd.md   (../../../../../../prds/00-delivery/corrections/f5-context-claim/specs/ 7 → 7
      w0-2/spec04.md           ]( 1 → 1
      docs/capabilities-terminal.md (spec02)  (../../../../../../prds/00-delivery/corrections/f5-context-claim/specs/ 7 → 7
      ```
...
grep -o '(../../../../../../prds/00-delivery/corrections/f5-context-claim/specs/' prds/02-terminal/03-f5-jump-mode/prd.md | wc -l       # 7
