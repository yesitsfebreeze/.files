...
(blink.cmp)" in [`capabilities-nvim.md`(../../../../../../prds/00-delivery/docs/capabilities-nvim.md)
```
...
(telescope)" in [`capabilities-nvim.md`(../../../../../../prds/00-delivery/docs/capabilities-nvim.md)
```
...
0.11)" in [`capabilities-nvim.md`(../../../../../../prds/00-delivery/docs/capabilities-nvim.md)
```
...
in [`capabilities-nvim.md`(../../../../../../prds/00-delivery/docs/capabilities-nvim.md)
```
...
history" in [`capabilities-nushell.md`(../../../../../../prds/00-delivery/docs/capabilities-nushell.md)
```
