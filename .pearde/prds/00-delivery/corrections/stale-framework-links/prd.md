...
nine `(../../../../../prds/00-delivery/corrections/prd/` relative links in `.mi/docs/delivery-gantt.md`,
...
- [x] **R1** — Each of the three citations is resolved one of two ways, chosen
      ...
      links in that file now resolve (checked by walking every `(../../../../../prds/00-delivery/corrections/stale-framework-links/…)` target).
...
- [x] **R4** — No other file in the tree still links into `.mi/workflows/`.
      ...
      as a string; a link is `(../../../../../prds/00-delivery/corrections/stale-framework-links/...)`, a mention is not.
