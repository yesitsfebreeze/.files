...
columns. [`pwd-closure-blast-radius`(../../../../../../prds/00-delivery/corrections/census-verdict-discipline/specs/pwd-closure-blast-radius/prd.md) ran it
in empty scratch directories, saw a hang, and wrote "That bullet is exact. Do
not touch it."
[`stale-pwd-latch-carriers`(../../../../../../prds/00-delivery/corrections/census-verdict-discipline/specs/stale-pwd-latch-carriers/prd.md) ran it in a
one-entry and a 200-entry directory, saw one message per fire, and refuted
it. [`autolist-width-guard-reason`(../../../../../../prds/00-delivery/corrections/census-verdict-discipline/specs/autolist-width-guard-reason/prd.md) varied
...
| `terminal-inventory-path-claim` R4 — "this inventory is the last carrier" | `refuted (single-dimension grep, prds and docs)`. [`gui-dies-claim-carriers`(../../../../../../prds/00-delivery/corrections/census-verdict-discipline/specs/gui-dies-claim-carriers/prd.md) found five more carriers with a three-dimensional grep, and [`truncated-source-attributions`(../../../../../../prds/00-delivery/corrections/census-verdict-discipline/specs/truncated-source-attributions/prd.md) turned seven into nine the same way |

Gating this vocabulary belongs to
[`retired-phrase-sweep`(../../../../../../prds/00-delivery/corrections/census-verdict-discipline/specs/retired-phrase-sweep/prd.md), and the paragraph above
...
```
  ...
  the [corrections backlog(../../../../../../prds/00-delivery/corrections/census-verdict-discipline/specs/prds/00-delivery/corrections/prd.md).
```
...
- **`02-terminal` is invalid as written.** The inventory
  ...
  [corrections backlog(../../../../../../prds/00-delivery/corrections/census-verdict-discipline/specs/prds/00-delivery/corrections/prd.md).
```
...
for f in sys.argv[1:]:
    for n, l in enumerate(open(f), 1):
        l = l.rstrip("\n")
        if l.startswith("|") or "(../../../../../../prds/00-delivery/corrections/census-verdict-discipline/specs/" in l:
            continue
        if len(l) > 78:
