...
[`capabilities-nvim.md`(../../../../../../prds/00-delivery/docs/capabilities-nvim.md)
```
...
[`shift-select-scope`(../../../../../../prds/00-delivery/decisions/00-delivery/decisions/shift-select-scope/prd.md)
...
silent: a later change to [`02-keymaps`(../../../../../../prds/00-delivery/decisions/shift-select-scope/02-keymaps/prd.md) or
[`03-autocmds`(../../../../../../prds/00-delivery/decisions/shift-select-scope/03-autocmds/prd.md) breaks the collapse semantics, every
...
- The header stays **C 7 · U 7**, matching the `Shift-to-select (editor-style
  selection)` entry in
  [`capabilities-nvim.md`(../../../../../../prds/00-delivery/docs/capabilities-nvim.md). The C 3 / U 5
...
- **This fork is closed; a worker does not re-take it.** An agent that finds
  ...
  [`04-corrections-backlog`(../../../../../../prds/00-delivery/decisions/00-delivery/corrections/prd.md) and stops.
