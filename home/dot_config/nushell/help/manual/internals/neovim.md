...
Claude panes start through `kern launch claude`. Kern owns the model connection and per-session credentials. The terminal provider passes through Claude’s IDE integration environment.
